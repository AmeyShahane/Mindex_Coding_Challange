...
public class CompensationController {
    ...
    /**
     * This method is used to call API endpoint and creates an entry in the repository for the given compensation object
    ...
    public Compensation create(@RequestBody Compensation compensation) {
        LOG.debug("Got compensation create request for [{}]", compensation);
        return compensationService.create(compensation);
    }

    /**
     * This method is used to call the API endpoint and returns the compensation object corresponding to an employeeId.
    ...
    public Compensation read(@PathVariable String employeeId) {
        LOG.debug("Got compensation read request for id [{}]", employeeId);
